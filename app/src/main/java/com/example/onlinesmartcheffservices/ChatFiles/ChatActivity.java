...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_model_classList = new ArrayList<>();
            CommentofPostDatabase = FirebaseDatabase.getInstance().getReference("comment").child(getIntent().getStringExtra("Pkey") + mAuth.getUid() );
        ...
        CommentofPostDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                CommentDataAdapter commentDataAdapter = new CommentDataAdapter(ChatActivity.this,comment_model_classList);
