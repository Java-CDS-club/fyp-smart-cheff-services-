    ...
    protected void onStart() {
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             try {
                 Adapter = new ShowCheffAdapterForChat(ShowCheffForChat.this, UserLaborList);
                 Adapter.set();
                 recyclerView.setAdapter(Adapter);
...
//                                 .addSwipeLeftActionIcon(R.drawable.ic_message_black_24dp).create().decorate();
                     ...
                     public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                      ...
                      if(direction == 8) {
                          ...
                          Toast.makeText(ShowCheffForChat.this, "Message Sent", Toast.LENGTH_SHORT).show();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowCheffForChat.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowCheffForChat.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(ShowCheffForChat.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
