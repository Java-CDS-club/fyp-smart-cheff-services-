...
import com.example.onlinesmartcheffservices.Cheff.ShowCustomerForChat;
...
public class ShowCheff extends AppCompatActivity {
  ...
  //                  getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.containerbtnstyle));
    ...
    private void init() {
    CheffFirebaseDatabase = FirebaseDatabase.getInstance().getReference("users");
    ...
    protected void onStart() {
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             try {
                 Adapter = new ShowCheffAdapter(ShowCheff.this, UserLaborList);
                 Adapter.set();
                 recyclerView.setAdapter(Adapter);
                 ...
                 final ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT| ItemTouchHelper.LEFT) {
                     ...
                     public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                         ...
                         new RecyclerViewSwipeDecorator.Builder(ShowCheff.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                 .addSwipeRightBackgroundColor(ContextCompat.getColor(ShowCheff.this , R.color.green))
                                 ...
                                 .addSwipeLeftBackgroundColor(ContextCompat.getColor(ShowCheff.this , R.color.yello))
                     ...
                     public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                      ...
                      if(direction == 8) {
                          ...
                          Toast.makeText(ShowCheff.this, "Message Sent", Toast.LENGTH_SHORT).show();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowCheff.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowCheff.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowCheff.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
