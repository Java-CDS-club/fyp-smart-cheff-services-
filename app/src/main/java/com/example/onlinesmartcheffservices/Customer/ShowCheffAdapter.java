...
public class ShowCheffAdapter extends RecyclerView.Adapter<ShowCheffAdapter.ViewHolder> implements Filterable {
    ...
    public ShowCheffAdapter(Activity mContext, List<UserModelClass> list) {
 ...
 @NonNull
    @Override
    public ShowCheffAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View v = LayoutInflater.from(mContext).inflate(R.layout.usersidelists , null);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ShowCheffAdapter.ViewHolder holder, int position) {
