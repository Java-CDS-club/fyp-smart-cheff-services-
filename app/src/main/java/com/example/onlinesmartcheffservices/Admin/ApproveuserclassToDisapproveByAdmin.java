...
public class ApproveuserclassToDisapproveByAdmin extends Fragment {
    List<UserModelClass> Disaprrove ;
    RecyclerView recyclerView ;
    public ApproveuserclassToDisapproveByAdmin() {
    }
    @Override
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if(!userModelClass.getUserType().equals("Admin") && userModelClass.getIsApprove().equals("true"))
                    {
                ...
                {
                    AccountsViewAdapterForDisable accountsViewAdapter = new AccountsViewAdapterForDisable(getContext() , Disaprrove) ;
