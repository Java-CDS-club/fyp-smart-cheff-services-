...
public class ViewAccountAndTheirRequests extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbar  ;
    DatabaseReference LaborShowFierbaseDatabase ;
    List<UserModelClass> UserLaborList ;
    RecyclerView recyclerView ;
    LinearLayoutManager linearLayoutManager   ;
    AccountsViewAdapterForCheckTheirRequests Adapter ;
    @Override
        ...
        try{
            LaborShowFierbaseDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    try {
                        Adapter = new AccountsViewAdapterForCheckTheirRequests(ViewAccountAndTheirRequests.this, UserLaborList);
                        recyclerView.setAdapter(Adapter);
                    }catch (Exception e){
