...
public class AccountsViewAdapter extends RecyclerView.Adapter<AccountsViewAdapter.ViewHolder> implements Filterable {
    ...
    public AccountsViewAdapter(Context mContext, List<UserModelClass> list) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AccountsViewAdapter.ViewHolder holder, int position) {
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(mContext)
                        .setTitle("Approve")
                        .setMessage("Are You Want Approve Account !")
