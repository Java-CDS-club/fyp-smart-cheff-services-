...
import com.example.onlinesmartcheffservices.ChatFiles.ChatActivity;
import com.example.onlinesmartcheffservices.ChatFiles.ChatActivityForCheff;
...
public class ShowCustomerAdapterForChat extends RecyclerView.Adapter<ShowCustomerAdapterForChat.ViewHolder> implements Filterable {
    ...
    public ShowCustomerAdapterForChat(Activity mContext, List<UserModelClass> list) {
 ...
 @NonNull
    @Override
    public ShowCustomerAdapterForChat.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View v = LayoutInflater.from(mContext).inflate(R.layout.usersidelists , null);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ShowCustomerAdapterForChat.ViewHolder holder, int position) {
        ...
        if(usersModelClass.getIsApprove().equals("true")){
            holder.Status.setText("Authanticate Cheff");
        }else{
            holder.Status.setText("UnAuthanticate Cheff");
...
//        });
        ...
        holder.location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent i = new Intent(mContext , ChatActivityForCheff.class);
