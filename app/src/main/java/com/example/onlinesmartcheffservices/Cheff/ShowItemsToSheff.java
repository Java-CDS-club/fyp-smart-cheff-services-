...
import com.example.onlinesmartcheffservices.Customer.ShowItemAdapter;
...
public class ShowItemsToSheff extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbar  ;
    DatabaseReference CheffFirebaseDatabase;
    List<ItemClass> UserLaborList ;
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                 ...
                 if (usersModelClass.getCheff_id().equals(mAuth.getUid())) {
             ...
             try {
                 Adapter = new ShowItemAdapter(ShowItemsToSheff.this, UserLaborList);
...
//                                 .addSwipeLeftActionIcon(R.drawable.ic_message_black_24dp).create().decorate();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowItemsToSheff.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowItemsToSheff.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowItemsToSheff.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
    }
