package com.example.onlinesmartcheffservices;
 ...
 imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             // update cons
                    UserModelClass userModelClass = new UserModelClass(
                            mAuth.getUid() , UserName, Emails, Password, Cnic, picUri , Phone,getIntent().getStringExtra("type") , Lattitude ,   Longitude,  "true"  , "true" , Rating);
                    UserFirebaseDatabasae.child(Keys).setValue(userModelClass);
                    Toast.makeText(UpdateProfile.this, "Successfull", Toast.LENGTH_SHORT).show();
                }
                else
                {
                   PictureUpdate() ;
    ...
    private void PictureUpdate() {
        try {
            ...
            // update cons
                            UserModelClass userModelClass = new UserModelClass(
                                    mAuth.getUid() , UserName, Emails, Password, Cnic, picUri , Phone,Lattitude , Longitude ,   getIntent().getStringExtra("type"),  "true"   , "false" , Rating   );
                            UserFirebaseDatabasae.child(Keys).setValue(userModelClass);
